...
: ${AMENT_CURRENT_PREFIX:="/root/spacedrone/install/coords"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/coords/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/coords/environment/path.sh"
